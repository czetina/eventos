...
urlpatterns = [
    ...
    path("cadenas/<int:pk>/reporte/", views.task_chain_report, name="chain_report"),
    path("cadenas/<int:pk>/reporte/excel/", views.task_chain_report_excel, name="chain_report_excel"),
