...
urlpatterns = [
    ...
    path("<int:pk>/cortejo/buscar/", views.wedding_party_search_guests, name="wedding_party_search_guests"),
    path("<int:pk>/cortejo/listas/unir/", views.wedding_party_type_merge, name="wedding_party_type_merge"),
    path(
        "<int:pk>/cortejo/listas/<int:list_type_pk>/vaciar/",
        views.event_wedding_party_list_clear, name="wedding_party_list_clear",
    ),
